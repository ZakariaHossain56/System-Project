...
import com.example.imagepro.PaymentRequest;
...
public class BkashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() == null) {
            ...
            Toast.makeText(this, "Amount is accepted", Toast.LENGTH_SHORT).show();
           ...
           // webSettings.sett=WebSettings.LOAD_NO_CACHE;
            ...
            wvBkashPayment.loadUrl("file:///android_asset/payment.php");   // api host link .
